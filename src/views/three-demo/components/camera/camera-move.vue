...
methods: {
    ...
    drawMultCube() {
        ...
        mesh.children[2].position.copy(new THREE.Vector3(-10, 4, 9))
        mesh.name = 'clone'
     ...
     */
    addSpotLightOptions() {
        this.lightFolder = this.$GUI.addFolder('光源参数')
        this.lightFolder.add(this.spotLightOptions, 'spotX', -100, 100).onChange(v => {
            this.spotLightOptions.spotX = v
            this.updateSpotLightPosition()
        })
        this.lightFolder.add(this.spotLightOptions, 'spotY', -100, 100).onChange(v => {
            this.spotLightOptions.spotY = v
            this.updateSpotLightPosition()
        })
        this.lightFolder.add(this.spotLightOptions, 'spotZ', -100, 100).onChange(v => {
     ...
     */
    addCameraOptions() {
        this.cameraFolder = this.$GUI.addFolder('镜头参数')
        this.cameraFolder.add(this.cameraOptions, 'positionX', -100, 100).onChange(v => {
            this.cameraOptions.positionX = v
            this.updateCameraOptions()
        })
        this.cameraFolder.add(this.cameraOptions, 'positionY', -100, 100).onChange(v => {
            this.cameraOptions.positionY = v
            this.updateCameraOptions()
        })
        this.cameraFolder.add(this.cameraOptions, 'positionZ', -100, 100).onChange(v => {
            this.cameraOptions.positionZ = v
            this.updateCameraOptions()
        })
        this.cameraFolder.add(this.cameraOptions, 'rotationX', -2, 2).onChange(v => {
            this.cameraOptions.rotationX = v * Math.PI
            this.updateCameraOptions()
        })
        this.cameraFolder.add(this.cameraOptions, 'rotationY', -2, 2).onChange(v => {
            this.cameraOptions.rotationY = v * Math.PI
            this.updateCameraOptions()
        })
        this.cameraFolder.add(this.cameraOptions, 'rotationZ', -2, 2).onChange(v => {
