...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // drawBoxGeometry() { // Geometry()--在125版里面已经被移除，这种写法淘汰了
      //   // 定义顶点集
      //   const vertices = [
      ...
      //   // 创建空的几何体对象
      //   const geom = new THREE.DirectGeometry() // 报错error:Geometry is not a constructor,原因：0.125版的three 中的Geometry()已经被移除了
      //   console.log(geom);
      //   // 给空的几何体对象赋值顶点集合三角面集合
